...
class RoleListView(ListView):
    model = Role
    template_name = "catalog/role_list.html"
    paginate_by = 20
...
class RoleDetailView(DetailView):
    model = Role
    template_name = "catalog/role_detail.html"
...
class RoleCreateView(CreateView):
    ...
    template_name = "catalog/role_create.html"
...
class RoleUpdateView(UpdateView):
    ...
    form_class = RoleForm
    # fields = ['name', 'description', 'sources', 'illustration']
    template_name = "catalog/role_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class RoleDeleteView(DeleteView):
    model = Role
    template_name = "catalog/role_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "role"
